...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='configs/yolov7/train/yolov7_tiny.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/my_coco.yaml', help='data.yaml path')
